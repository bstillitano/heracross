...
```sh
npm install github:bstillitano/heracross#v0.2.0
```

`#v0.2.0` pins the release. Leave it off to track unreleased changes on `main`. Releases and what changed in each are listed in the [changelog](CHANGELOG.md).
...
| Component | Version |
|---|---|
| Heracross | 0.2.0, installed from GitHub; not published to npm |
